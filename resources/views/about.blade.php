                            ...
                            <div class="text-center mb-6 mb-md-0">
                                <div class="mb-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="currentColor"
                                        class="bi bi-people text-primary" viewBox="0 0 16 16"><path
                                ...
                                <div class="text-dark fs-5">Customers</div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                            <div class="text-center mb-6 mb-md-0">
                                ...
                                <div class="text-dark fs-5">Loan</div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                                ...
                                <div class="row">
                                    <div class=" col-md-6 col-12  ">
                                        ...
                                        <div class="d-flex align-items-center mt-4">
                                            <div> <img src="{{ asset('frontend/images/avatar/avatar-1.jpg') }}" alt="Borrow - Loan Company Website Template"
                                    ...
                                    <div class=" col-md-6 col-12  ">
                                        ...
                                        <div class="d-flex align-items-center mt-4">
                                            <div> <img src="{{ asset('frontend/images/avatar/avatar-2.jpg') }}" alt="Borrow - Loan Company Website Template"
                                                class="avatar avatar-lg rounded-3">
                                            </div>
                                            <div class="ms-3 lh-1">
                                            ...
                                            <div class="card-body p-6">
                                                <div class="mb-5"><svg xmlns="http://www.w3.org/2000/svg" width="48" height="48"
                                                    ...
                                                    <path
                                                        ...
                                                        <a href="{{ url('register') }}" class="btn-link border-bottom border-primary border-2 fw-bold fs-5">Get
                                                        Register</a>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card mb-3 mb-lg-0 text-center">
                                                    <div class="card-body p-6">
                                                        <div class="mb-5"><svg xmlns="http://www.w3.org/2000/svg" width="48" height="48"
                                                            ...
                                                            <h1 class="fs-3">(913) 543-8749 </h1>
                                                            <p> <a href="#" class="fs-5">lnfo@cashpeerup.com</a></p>
                                                    ...
                                                    <div class="card mb-3 mb-lg-0  text-center">
                                                        <div class="card-body p-6">
                                                            <div class="mb-5"> <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48"
                                                                ...
                                                                <a href="#!" class="btn-link border-bottom border-primary border-2 fw-bold fs-5">Use Chat</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
