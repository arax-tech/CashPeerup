                                        ...
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Withdraw Now</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form method="post" enctype="multipart/form-data" action="{{ url('user/withdraw/store') }}">
                                                        @csrf
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="modal fade" id="UpdateLoan{{ $withdraw->id }}">
                                                            <div class="modal-dialog modal-xl">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form method="post" enctype="multipart/form-data" action="{{ url('user/withdraw/update/'.$withdraw->id) }}">
                                                                            @csrf
                                                                            <div class=" row align-items-center">
                                                        ...
                                                        <a rel="{{ $withdraw->id }}" rel1="user/withdraw/delete" class="btn btn-danger Delete" href="javascript::">Delete</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
