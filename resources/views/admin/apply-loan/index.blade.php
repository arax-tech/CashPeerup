                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                            ...
                                                            <div class="modal-dialog modal-xl">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form method="post" enctype="multipart/form-data" action="{{ url('admin/loan-application/update/'.$loan->id) }}">
                                                                            @csrf
                                                        ...
                                                        <a rel="{{ $loan->id }}" rel1="admin/loan-application/delete" class="btn btn-danger Delete" href="javascript::">Delete</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
